    ...
    <section className="relative w-full min-h-screen">
      <div className="relative w-full h-screen">
        ...
        <div className="absolute top-[80%] md:top-[70%] left-6 md:left-16 -translate-y-1/2 text-white z-10 max-w-xl">
          ...
          <Link href="/wheels">
  <button className="mt-4 md:mt-6 px-4 md:px-6 py-2 md:py-3 bg-white text-black font-semibold text-sm md:text-base rounded hover:bg-gray-200 transition cursor-pointer">
    Explore Collections
  </button>
</Link>
        </div>
